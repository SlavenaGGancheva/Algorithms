...
var actual_1 = detectOutlierValue("2 4 7 8 10"); // => 3 - Third number is odd, while the rest of the numbers are even
var expected_1 = 3
assertEqual(actual_1, expected_1, 'should work with sole odd number');

var actual_2 = detectOutlierValue("1 10 1 1");  //=> 2 - Second number is even, while the rest of the numbers are odd
var expected_2 = 2;
