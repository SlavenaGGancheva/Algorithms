...
function solution(integers) {
  ...
  let result = [];
  // create start index variable, equal to 0
  let start = 0;
  // create next index variable, equal to 1
  let next = 1;
  // create end index variable, equal to 2
  let end = 2;
  ...
  while (start < integers.length) {
    ...
    if (integers[end] - integers[next] === 1 && integers[next] - integers[start] === 1) {
      ...
      // create proper string format of slice, and add to result
